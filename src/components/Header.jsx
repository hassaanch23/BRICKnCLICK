      ...
      <div className="flex justify-between items-center p-3 max-w-8xl mx-auto">
        ...
        <form className="bg-gray-300 rounded-lg p-2 flex items-center">
          <input
            type="text"
            placeholder="Search..."
            className="bg-transparent focus:outline-none rounded-md w-24 sm:w-64 md:w-90 pr-3"
          />
          <FaSearch className="text-gray-800" />
        </form>
        <ul className="flex gap-4 text-gray-50 md:gap-8 text-sm sm:text-base font-semibold md:mr-10">
          <Link to="/">
